...
const About = () => {
  return (
    <>
      ...
      >
        An Electrical Engineering student shaping the future of secure and
        intelligent hardware. Specializing in semiconductors, embedded
        systems, and advanced computing with a focus on performance,
        security, and innovation. Building towards a world where silicon
        meets intelligence.
      </motion.p>
